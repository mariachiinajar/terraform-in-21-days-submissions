...
# translate the JSON text into a terraform object and query using the standard terraform secret. 
# A way to declare variables, similar to local env variables. 
locals {
